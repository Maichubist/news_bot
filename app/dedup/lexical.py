...
STOPWORDS = {
    ...
    "який", "яка", "яке", "які", "якого", "якої", "яких",
    "цей", "цього", "цьому", "цим", "така", "таке", "такі", "такий",
    "від", "для", "при", "під", "над", "про", "без", "через", "щодо",
    "після", "перед", "поки", "якщо", "коли", "тому", "тоді", "далі",
    "також", "тільки", "лише", "вже", "іще", "досі", "понад", "майже",
    "буде", "було", "була", "були", "бути", "став", "стала", "стало",
    "має", "мають", "можна", "треба", "слід",
    "року", "роки", "році", "днів", "годин", "хвилин",
    "новини", "новина", "останні", "наживо", "оновлено", "детальніше",
    "сьогодні", "вчора", "завтра", "зараз",
    "проти", "серед", "між", "крім", "окрім", "разом",
    "свого", "своєї", "своїх", "його", "їхній", "їхня",
    "повідомляє", "повідомили", "пише", "джерело",
}
